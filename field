...
const default_options = {
  ...
  imageURL: {
    ...
    display: "select",
    values: [
      {"Football": "https://cdn.pixabay.com/photo/2017/01/31/08/32/field-2023250_960_720.png"}
    ],
    default: "https://cdn.pixabay.com/photo/2017/01/31/08/32/field-2023250_960_720.png",
  },
  defaultIconURL: {
    section: "Image",
    type: "string",
    ...
    display: "text",
    default: "https://upload.wikimedia.org/wikipedia/commons/d/d4/Soccer_Jersey_Grey.png",
  },
  // Scale and Padding
  minX: {
    section: "Scales",
